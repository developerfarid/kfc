        ...
        <>
            ...
            <div className='mt-24'>
                <div className='flex justify-end mb-8 px-8 pt-8'>
                    ...
                    <Link to='/Dashboard/Coach/0' className='btn-update'><IoIosAddCircleOutline className=' mr-3 text-2xl' /> Add Coach</Link>
                </div>
                <div className='px-8'>
                                ...
                                <table className="table-auto text-center">
                                    <thead className='pb-3'>
                                        <tr>
                                            ...
                                            <th className='pb-3 text-sm md:text-lg font-semibold'>Coach Name</th>
                                        ...
                                        {isDataPresent && (dataArray.map((item, index) => (
                                            <><tr className='bg-bg-body' key={item.id}>
                                                ...
                                                <td className='py-3 my-2 rounded-r-lg '>
                                                    <Link to={`/Dashboard/Coach/${item.id}`}><AiOutlineEdit className='text-center inline-block' /></Link>
                                                </td>
                                            </tr>

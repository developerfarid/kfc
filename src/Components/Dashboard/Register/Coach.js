...
const Coach = () => {
                    ...
                    success: function (data) {
                        ...
                        if (responseObj[0] == 'SUCCESS') {
                            ...
                            if (responseObj[1] == 'DATA_FOUND') {
                                ...
                                console.log('img_path->' + detail.img_path);
                                name.current.focus();
                                salary.current.value = detail.salary;
                                totalmatch.current.value = detail.totalmatch;
                                noofteams.current.value = detail.noofteams;
    ...
    function addToDB() {
        try {
            ...
            formData.append('noofteams', noofteams.current.value);
    ...
    return (
        <>
            <div className='bg-white h-24 flex justify-between px-8 items-center fixed top-0 left-3/12 right-0 w-9/12'>
                <h2 className='text-lg'>Registration  <span className='text-gray-600'>(Coach)</span></h2>
                        ...
                        <div className='container flex flex-col  justify-center'>
                            <div className='flex flex-col bg-bg-gray p-8 rounded-2xl border-[20px] border-white ' >
                                ...
                                <div className='md:grid md:grid-cols-2 gap-5'>
                                    ...
                                    <div>
                                        <label className="block text-gray-600 text-base font-semibold mb-3" htmlFor="noofteams">
                                            No Of Teams
                                        </label>
                                        {/* <input type='number' className='w-full px-6 py-3 rounded-lg focus:outline-none border placeholder-gray-500 focus:ring-indigo-500   focus:z-10' id='teams' placeholder="33" {...register("teams", { required: true })} />
                                        {errors?.teams && <p className='mt-1 text-red-500 text-sm'>This field is required</p>} */}
                                        <input ref={noofteams} type='number' className='w-full px-6 py-3 rounded-lg focus:outline-none border placeholder-gray-500 focus:ring-indigo-500   focus:z-10' id='noofteams' placeholder="" />
                                    </div>
                                    <div>
                                    ...
                                    <div className=' col-span-full'>
                                        ...
                                        <textarea value={descVal} onChange={handleDescChange} className='w-full h-36 px-6 py-3 rounded-lg focus:outline-none border placeholder-gray-500 focus:ring-indigo-500   focus:z-10' id='description' placeholder="Information about coach" />
                                    </div>

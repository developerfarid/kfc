                                ...
                                <table className="table-auto text-center">
                                    <thead className='pb-3'>
                                        <tr>
                                            ...
                                            <th className='pb-3 text-sm md:text-lg font-semibold'>Contact No</th>
                                            <th className='pb-3 text-sm md:text-lg font-semibold'>Address</th>
                                    ...
                                    <tbody className=''>
                                        ...
                                        {isDataPresent && (dataArray.map((item, index) => (
                                            <><tr className='bg-bg-body' key={item.id}>
                                                ...
                                                <td className='py-3 my-2'>{item.contactno}</td>
                                                <td className='py-3 my-2'>{item.address}</td>
                                                <td className='py-3 my-2'>{item.maplocation}</td>
                                                <td className='py-3 my-2 rounded-r-lg '>
                                                    <Link to={`/Dashboard/Academy/${item.id}`}><AiOutlineEdit className='text-center inline-block' /></Link>
                                                </td>
                                            </tr>

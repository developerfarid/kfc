    ...
    function approveOrRejectRequest(id, isRequestApproved) {
        try {
            if (id > 0) {
                ...
                formData.append('source', 'referees');
    ...
    return (
        <>
            <div className='bg-white h-24 flex justify-between px-8 items-center fixed top-0 left-3/12 right-0 w-9/12'>
                <h2 className='text-lg'>Approval <span className='text-gray-600'>(Referee)</span></h2>
                        ...
                        <div className='container flex flex-col  justify-center'>
                            ...
                            <table className="table-auto text-center">
                                    <thead className='pb-3'>
                                        <tr>
                                            <th className='pb-3 text-lg font-semibold'>No</th>
                                            <th className='pb-3 text-lg font-semibold'>Referee Name</th>
                                            <th className='pb-3 text-lg font-semibold'>Date From</th>
                                            <th className='pb-3 text-lg font-semibold'>Date To</th>
                                            <th className='pb-3 text-lg font-semibold'>Requested By</th>
                                            <th className='pb-3 text-lg font-semibold'>Approve?</th>
                                        </tr>
                                    </thead>
                                    <tbody className=''>
                                        ...
                                        {isDataPresent &&
                                            dataArray.map((item, index) => (
                                                <><tr className='bg-bg-body'>
                                                    ...
                                                    <td className='py-3 my-2'>{item.date_from}</td>
                                                    <td className='py-3 my-2'>{item.date_to}</td>

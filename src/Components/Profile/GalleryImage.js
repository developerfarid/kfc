...
const GalleryImage = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            $.ajax({
                ...
                url: window.BACK_END_URL + 'userRequestGallery.php',
                cache: false
            });
        }
        fetchData();
    ...
    return (
        ...
        { isImagePresent && 
            dataArray.map((item, i) => <GallerySingleItem key={i} item={item} />)
        }
    </div>
    </>
    );
